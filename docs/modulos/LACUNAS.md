...
| **o `nfse-municipal` não distribui artefato** | é módulo de conhecimento: a origem é privada e continua privada, e o catálogo carrega a estrutura, não o código. A F6 constrói a partir do plano e das armadilhas, sob TDD — não há o que copiar (D20) | nada a fechar: é o desenho, e está declarado nas seções 10 e 14 do módulo |
